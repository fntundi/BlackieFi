...
help: ## Show this help message
	...
	@echo "\033[0;36m╚═══════════════════════════════════════════════════════════════════╝\033[0m"
	@echo ""
	@echo "\033[0;33m*** RECOMMENDED FOR LOCAL DEVELOPMENT ***\033[0m"
	@echo "  \033[0;32mmake local-up\033[0m        - Start with Docker (MongoDB + Redis + Backend + Frontend)"
	@echo "  \033[0;32mmake local-down\033[0m      - Stop all services"
	@echo "  \033[0;32mmake local-logs\033[0m      - View logs"
	@echo ""
	@echo "\033[0;33mQUICK START:\033[0m"
	@echo "  \033[0;32mmake setup\033[0m           - First-time setup (install all dependencies)"
	@echo "  \033[0;32mmake dev\033[0m             - Start backend + frontend (no Docker)"
	...
	@echo ""
	@echo "\033[0;33mLOCAL DEVELOPMENT (Docker - Recommended):\033[0m"
	@echo "  \033[0;32mmake local-up\033[0m        - Start local dev environment"
	@echo "  \033[0;32mmake local-down\033[0m      - Stop local dev environment"
	@echo "  \033[0;32mmake local-logs\033[0m      - View all logs"
	@echo "  \033[0;32mmake local-build\033[0m     - Rebuild images"
	@echo "  \033[0;32mmake local-restart\033[0m   - Restart all services"
	@echo "  \033[0;32mmake local-clean\033[0m     - Remove containers and volumes"
	@echo ""
